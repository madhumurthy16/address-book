  ...
  describe('ContactController', () => {
  	...
  	describe("#addContact()", () => {
  		it("should add a single contact into the book", (done) => {
  			this.book.addContact("Madhu", "415-367-5067", "msmurthy@msn.com")
  			.then((contacts) => {
  				expect(contact.name).toBe("Alice");
  				expect(contact.phone).toBe("444-444-4444");
  				expect(contact.email).toBe("id@email.com");
  				done();
  			})
  			.catch((err) => {
  				done();
  	...
  	describe("#getContacts()", () => {
  		...
  		it("should return an array of contacts when contacts are available", (done) => {
  			this.book.addContact("Manisha", "415-367-5068", "manishamurthymurthy@icloud.com")
  			.then(() => {
  				this.book.getContacts()
  				.then((contacts) => {
    ...
    describe("search methods", () => {
      ...
      describe("#iterativeSearch()", () => {
        ...
        it("should return null when no contact is found", (done) => {
  ...
  describe("#delete()", () => {
    it("should not remove any contacts that do not match the ID passes", (done) => {
